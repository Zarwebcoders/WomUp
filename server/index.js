...
const fs = require('fs');
// Removed node-cron as it causes Vercel serverless functions to hang and return 500 errors
...
incomeRoutes.get('/cron/reveal', require('./controllers/incomeController').revealHiddenIncomes);
